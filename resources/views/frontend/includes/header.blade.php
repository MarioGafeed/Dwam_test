...
<header class="type4 transition-5 relative mg-header mg-header-dark">
            ...
            <div class="col-md-8 col-4 text-right ">
                ...
                <ul class="nav nav-links1 list-type2 justify-content-center">
                    ...
                    <li class="mg-nav-item mg-nav-item-has-children nav-link">
                        ...
                        <ul class="sub-menu">
                            <li class="mg-nav-item nav-link"> <a href="index.html">{{ trans('main.books') }}</a></li>
                            <li class="mg-nav-item nav-link"> <a href="index-2.html">{{ trans('main.book_room') }}</a></li>
                        </ul>
                    </li>
                    <li class="mg-nav-item mg-nav-item-has-children nav-link">
    ...
    <a href="donate.html" class="db-block ml-35 ml-xs-25">
        <div class="transform-center">DONATE</div>
    </a>
        ...
        <div class="icon-links d-flex align-items-center justify-content-end">
            ...
            <div class="fx-menu-wrapper bg-yellow-op-9 transition-5 d-flex justify-content-between flex-column">
                <div class="fx-menu-header d-flex justify-content-between">
                    <p class="rbt-slab fs-13 f-700">DWAM</p>
                ...
                <a href="donate.html" class="btn btn-black mt-30 mb-35 mb-xs-20">DONATE</a>
                <div class="fx-menu-content mb-15">
                    <ul class="fx-menu-links rbt-slab">
                        <li> <a href="#" >Home</a>
                        </li>
                        <li> <a href="#" class="has-sub">VIDEOS</a>
                            <ul class="submenu">
                              <li class="mg-nav-item nav-link"> <a href="index-2.html">{{ trans('main.live_videos') }}</a></li>
                              @foreach($vcats as $vcat)
                                <li class="mg-nav-item nav-link"> <a href="{{ url("/vcatposts/show/{$vcat->id}") }}">
                        ...
                        <li> <a href="#" class="has-sub">SERVICES</a>
                            <ul class="submenu">
                              <li class="mg-nav-item nav-link"> <a href="index.html">{{ trans('main.books') }}</a></li>
                              <li class="mg-nav-item nav-link"> <a href="index-2.html">{{ trans('main.book_room') }}</a></li>
                            </ul>
                        </li>
                        <li> <a href="#" class="has-sub">BLOGS</a>
                            <ul class="submenu">
                              @foreach($pcats as $pcat)
                                <li class="mg-nav-item nav-link"> <a href="{{ url("/catposts/show/{$pcat->id}") }}">
                                    @if(GetLanguage() == 'en')
